...
public class InboxAdapter extends RecyclerView.Adapter<InboxAdapter.CustomViewHolder> implements Filterable{
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewtype) {
        ...
        view.setLayoutParams(new RecyclerView.LayoutParams(RecyclerView.LayoutParams.MATCH_PARENT, (int) context.getResources().getDimension(R.dimen.margin_80)));
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int i) {
        ...
        Log.d("Adapter Value", "Adapter Value: "+item.getStatus());
        if (status.equals("0")) {
